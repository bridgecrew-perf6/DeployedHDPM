...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 16, vars: 4, consts: [[1, "d-flex", "justify-content-center"], ["id", "loginform-bg", 1, "shadow", "rounded", "login-container"], [1, "form", 3, "formGroup"], ["class", "ex-font alert alert-danger alert-dismissible fade show alert-pop", "role", "alert", 4, "ngIf"], [1, "input-border", "login-input", "p-1"], ["matInput", "", "placeholder", "Email", "formControlName", "Email"], ["Email", ""], ["matInput", "", "placeholder", "Password", "formControlName", "Password", 3, "type"], ["Password", ""], ["matSuffix", "", 3, "click"], ["type", "button", "mat-button", "", 1, "main-btn", "login-btn", 3, "click"], ["role", "alert", 1, "ex-font", "alert", "alert-danger", "alert-dismissible", "fade", "show", "alert-pop"], ["type", "button", "data-dismiss", "alert", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
